...
typedef struct MEM_Storage_tag *MEN_Storage;
...
void *MEM_strdup_func(MEM_Controller controller,
...
void MEM_free_func(MEN_Controller controller,void *ptr);
...
#define MEM_relloc(ptr,size)\
  (MEM_realloc_func(MEM_CURRENT_CONTROLLER,__FILE__,__LINE__,ptr,size))
#define MEM_strdup(size)\
  (MEM_strdup_func(MEM_CURRENT_CONTROLLER,__FILE__,__LINE__,size))
